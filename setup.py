...
setup_args = {
    ...
    'url'              : 'https://github.com/radical-cybertools/Replica',
    'license'          : 'MIT',
    'keywords'         : "replica simulation analysis",
    'classifiers'      :  [
    ...
    'package_dir'       : {'': 'src'},
    'scripts'           : ['bin/replica-version'],                        
    'package_data'      :  {'': ['*.sh', '*.json', 'VERSION', 'SDIST']},
    'install_requires'  :  ['radical.utils','autodoc','pytest',
                            'hypothesis','sphinx'],
    'zip_safe'          : False,
